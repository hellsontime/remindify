...
function EmptyTasksComponent() {
  return (
    <div className="empty-tasks">
      <div className="empty-tasks__hero">
        <span>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
            <circle cx="18" cy="17.018" fill="#ffcb4c" r="17" id="circle" />
            <g fill="#65471b" id="eyes">
              <path d="m14.524 21.036c-.145-.116-.258-.274-.312-.464-.134-.46.13-.918.59-1.021 4.528-1.021 7.577 1.363 7.706 1.465.384.306.459.845.173 1.205-.286.358-.828.401-1.211.097-.11-.084-2.523-1.923-6.182-1.098-.274.061-.554-.016-.764-.184z" />
        ...
        <p>There are no tasks bla bla bla...</p>
      </div>

      <div className="empty-tasks__button">
        <span>
